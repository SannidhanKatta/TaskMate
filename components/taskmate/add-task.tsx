...
const AddTask = ({
  ...
  const [updatedStatus, setUpdatedStatus] = useState(
    `{"columnId":"${state.newTask?.columnId}","columnStatus":"${state.newTask?.status ? state.newTask?.status : "Todo"
    }", "boardId":"${boardId}"}`
  );
      ...
      <Form.Root className="w-full">
        ...
        <div className="flex flex-col gap-2">
          ...
          {newStatus === undefined ||
            ...
            <div className={`border-[1.2px] px-2 py-1 inline-block text-[8px] rounded w-[70%] mt-4 shadow-md ${darkMode
          ...
          <Form.Submit asChild>
            ...
            >
              <div className={`${newStatus === undefined ||
                !changed ||
