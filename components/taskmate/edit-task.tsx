...
import { commonClasses } from "./taskmate-grid-styles";
        ...
        <div className="flex flex-col gap-2 mb-0">
          ...
          {disableAddBtn && !subtaskAdded ? (
            <div className="flex flex-row gap-4 justify-start align-middle items-center">
              <button
                className={`h-10 relative w-[300px] rounded-2xl bg-indigo-500  hover:bg-indigo-700 transition-colors ease-in delay-150 cursor-pointer ${subTaskLoading && "animate-pulse bg-indigo-300"
                  }`}
          ...
          <div className="flex h-8 flex-row gap-4 justify-start items-center align-middle">
            <Form.Submit asChild>
              <button
                className={`mt-6 flex justify-center text-center w-full h-10 bg-indigo-500 hover:bg-indigo-700 rounded-2xl align-middle items-center cursor-pointer disabled:bg-indigo-200  disabled:cursor-not-allowed  ${loading ? "cursor-wait animate-pulse" : "cursor-pointer"
                  }`}
